// af_ValidateAndMapExternalUser â€” RC-extended version
...
internal Item AutoCreateMicrosoftUser(Innovator inn, string email, string upn, string displayName)
{
	...
	// Elevate to "Administrators" â€” the impersonation context invoking this method
	...
	using (_permissions.GrantIdentity(adminIdent))
	{
		...
		// Random password â€” never used (login goes through Entra), but Aras requires non-null
